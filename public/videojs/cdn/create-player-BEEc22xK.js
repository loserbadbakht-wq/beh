import { a as isNull, i as isNil, r as isFunction, s as isObject, u as isUndefined } from "./predicate-faYxAB6Z.js";
import { n as getCanonicalLocaleKey, s as DEFAULT_LOCALE, t as findLocaleKeys } from "./i18n-DyF_NfCk.js";
import { t as shallowEqual } from "./shallow-equal-C7S8rj2f.js";
import { n as ContextConsumer } from "./media-element-CJY3JIgc.js";
import { n as mediaContext, r as playerContext, t as containerContext } from "./context-OhQY847V.js";
import { l as ContextProvider } from "./container-element-HHK_KZOE.js";
		...
		class PlayerProviderElement extends BaseClass {
			...
			willUpdate(changed) {
				...
				for (const { property, entry } of inputs) {
					...
					setPlayerConfigValue(this.store, entry, this[property]);
				}
			}
			#tryAttach() {
			...
			#syncInitialConfig() {
				...
				for (const { property, entry } of inputs) setPlayerConfigValue(store, entry, this[property]);
