import { a as isNull, l as isString, u as isUndefined } from "../predicate-DrcmolBs.js";
...
//#region ../../node_modules/.pnpm/@vimeo+player@2.30.4/node_modules/@vimeo/player/dist/player.es.js
...
//#endregion
//#region ../media/dist/dev/dom/vimeo/media.js
...
var VimeoMedia = class extends VimeoMediaBase {
	...
	#source = vimeoMediaDefaultProps.source;
	#paused = true;
	#ended = false;
	#seeking = false;
	#currentTime = 0;
	...
	#setupTextTracks(player) {
		...
		player.getTextTracks().then((tracks) => {
			for (const track of tracks) {
				...
				tryCall(() => host.addTextTrack?.(track.kind, track.label ?? "", track.language ?? ""));
			}
		}).catch(() => {});
...
function buildVimeoIframeSrc(src, props = {}) {
	...
	const params = {
		...
		transparent: false,
		h: parsed.hash,
		...props.source?.engine?.vimeo ?? void 0
	};
...
function toLoadVideoOptions(src, vimeo) {
	const parsed = parseVimeoSource(src);
...
//#endregion
//#region src/media/vimeo-video/media.ts
var VimeoCustomMediaElement = class extends CustomMediaElement("iframe", VimeoMedia) {
	static {
...
var VimeoVideo = class extends MediaAttachMixin(VimeoCustomMediaElement) {};

//#endregion
//#region src/define/media/vimeo-video.ts
var VimeoVideoElement = class extends VimeoVideo {
	static {
		this.tagName = "vimeo-video";
	}
};
...
//# sourceMappingURL=vimeo-video.dev.js.map